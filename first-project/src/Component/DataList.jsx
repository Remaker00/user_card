...
const DataList = ({ filteredData, onDeleteUser, onEditUser }) => {
  ...
  const handleSubmitClick = () => {
    console.log(selectedItems, teamName);
  }
  ...
  return (
    <div>
      <div className='create-team'>
        ...
        <button onClick={handleShowCartClick}>{showCart ? 'Hide Cart' : 'Show Cart'}</button>
        {showCart && (
          <div className="cart-modal">
            <CartComponent selectedItems={selectedItems} onSubmit={handleSubmitClick} />
          </div>
        )}
      </div>
